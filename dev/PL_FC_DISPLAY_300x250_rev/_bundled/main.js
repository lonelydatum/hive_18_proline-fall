...
console.log((0, _commonJsProline.arrayClean)(_super3.hand_super3, 5));

// 174 260 188

console.log(_super1.hand_super1.length, _super2.hand_super2.length, _super3.hand_super3.length);
...
function do_super1() {
    ...
    (0, _commonJsProline.hand)(_super1.hand_super1, "super1", { brushSize: 8, speed: 2 }).then(do_super2);
}

function do_super2() {
    TweenMax.set('#super2', { opacity: 1 });
    (0, _commonJsProline.hand)(_super2.hand_super2, "super2", { brushSize: 5, speed: 2 }).then(do_super3);
}

function do_super3() {
    TweenMax.set('#super3', { opacity: 1 });
    (0, _commonJsProline.hand)(_super3.hand_super3, "super3", { brushSize: 5, speed: 2 }).then(do_arrow_yellow_1);
}
...
},{"../../_common/js/proline":9,"./arrow_green_1":1,"./arrow_green_2a":2,"./arrow_yellow_1":3,"./cta_circle":4,"./super1":6,"./super2":7,"./super3":8,"handwrite":10}],6:[function(require,module,exports){
"use strict";
...
},{"handwrite":10}],10:[function(require,module,exports){
