...
function do_super1() {
    ...
    (0, _commonJsProline.hand)(_super1.hand_super1, "super1", { brushSize: 8, speed: 5 }).then(do_super2);
}
...
function do_super3() {
    ...
    (0, _commonJsProline.hand)(_super3.hand_super3, "super3", { brushSize: 5, speed: 5 }).then(do_arrow_yellow_1);
}
