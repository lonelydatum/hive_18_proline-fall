...
function do_super() {
    ...
    (0, _commonJsProline.hand)(_super1.hand_super1, "super", { brushSize: 3, speed: 4 }).then(logo);
}

function logo() {

    TweenMax.to("#logo_pro", .5, { opacity: 1, delay: .4, onComplete: function onComplete() {} });
...
},{"../../_common/js/proline":4,"./cta_circle":1,"./super1":3,"handwrite":5}],3:[function(require,module,exports){
"use strict";
...
},{"handwrite":5}],5:[function(require,module,exports){
