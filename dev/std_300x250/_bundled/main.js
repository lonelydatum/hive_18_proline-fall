...
console.log((0, _commonJsProline.arrayClean)(_super2.hand_super2, 2));
...
function start() {
    ...
    var p1 = (0, _commonJsProline.hand)(_super1.hand_super1, "super1", { brushsize: 8, speed: 7 }).then(function () {
        TweenMax.set('#super2', { opacity: 1 });
        (0, _commonJsProline.hand)(_super2.hand_super2, "super2", { brushsize: 5, speed: 5 });
    }).then(function () {
        TweenMax.set('#super3', { opacity: 1 });
        (0, _commonJsProline.hand)(_super2.hand_super3, "super3", { brushsize: 5, speed: 5 });
    });
}

},{"../../_common/js/proline":1,"./super1":3,"./super2":4,"handwrite":5}],3:[function(require,module,exports){
"use strict";
